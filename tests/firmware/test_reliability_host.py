...
@pytest.mark.parametrize("component", ["lease_guard", "file_transaction", "worker_retry", "reliability", "durable_queue", "legacy_queue", "delivery_scheduler", "uid_cache", "storage_budget", "evidence_receipt"])
