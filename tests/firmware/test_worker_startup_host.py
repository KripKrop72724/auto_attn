...
def test_startup_retries_do_not_reboot_or_recreate_healthy_capture(tmp_path):
...
static void ords_uploader_task(void *arg){(void)arg;}
...
static void add_connector_report_ords_start(bool started,uint32_t attempts){assert(started==ords_created);reported_attempts=attempts;}
