...
foreach ($version in @('2.5.4', '2.6.0', '2.6.1', '2.6.2', '2.6.3', '2.6.4', '2.6.5', '2.6.6', '2.6.7', '2.6.8', '2.6.9')) {
    $mode = if ($version -eq '2.6.0') { 'SEGMENTED' } else { 'LEGACY' }
    $marker = if ($version -eq '2.6.9') {
    ...
    if ($version -in @('2.6.1', '2.6.2', '2.6.3', '2.6.4', '2.6.5', '2.6.6', '2.6.7', '2.6.8', '2.6.9') -and
    ...
    if ($version -in @('2.6.7', '2.6.8', '2.6.9') -and
        ($contract.allowed_bootstrap_versions.Count -ne $(if ($version -eq '2.6.9') { 5 } elseif ($version -eq '2.6.8') { 4 } else { 3 }) -or
