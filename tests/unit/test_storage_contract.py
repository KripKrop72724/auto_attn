...
def manifest(version):
    if version in ("2.6.1", "2.6.2", "2.6.3"):
...
def test_signed_contract_required_for_both_storage_releases():
    for version in ("2.5.4", "2.6.0", "2.6.1", "2.6.2", "2.6.3"):
...
@pytest.mark.parametrize("bad", ["2.4.11", "2.5.4", "zone-lite-2.5.4", "2.6.0", "2.6.1", "2.6.2", "2.6.3", "2.7.0", None])
@pytest.mark.parametrize("direct_version", ["2.6.1", "2.6.2", "2.6.3"])
