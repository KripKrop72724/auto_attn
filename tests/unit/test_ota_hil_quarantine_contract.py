...
def test_production_canary_promotion_fails_closed_on_exact_runtime_evidence() -> None:
    ...
    for required in (
        ...
        "$sourceCoverage.oracle_evidence",
        "$sourceCoverage.capture_evidence.certified_at",
        "$sourceCoverage.oracle_evidence.certified_at",
        "$sourceCoverage.capture_evidence.job_id",
        "$sourceCoverage.oracle_evidence.job_id",
        "$sourceCoverage.capture_evidence.source_chain_digest",
        "$sourceCoverage.oracle_evidence.source_chain_digest",
        "fresh-full-source",
        "proved neither a poison-safe bounded tail nor a fresh full-source",
