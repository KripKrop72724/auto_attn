function Get-FirmwareStorageContract {
    ...
    if ($Version -notin @('2.5.4', '2.6.0', '2.6.1', '2.6.2', '2.6.3', '2.6.4', '2.6.5', '2.6.6', '2.6.7', '2.6.8')) {
    ...
    if ($Version -in @('2.6.1', '2.6.2', '2.6.3', '2.6.4', '2.6.5', '2.6.6', '2.6.7', '2.6.8')) {
        ...
        return [ordered]@{
            ...
            allowed_bootstrap_versions = $(if ($Version -eq '2.6.8') { @('2.4.12', '2.5.2', '2.6.6', '2.6.7') } elseif ($Version -eq '2.6.7') { @('2.4.12', '2.5.2', '2.6.6') } else { @('2.4.12', '2.5.2') })
            read_format = 2
            reader_mask = 63
            schema_version = 2
            write_format = 1
