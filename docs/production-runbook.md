...
operation replay, daily-flag, downstream stale-identity-removal, and controlled 1/10/50 punch
gates in the [Attendance blocked-punch review and ORDS release runbook](attendance-repair-runbook.md).
